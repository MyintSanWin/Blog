        ...
        <x-panel class="max-w-sm mx-auto">
            <form action="/admin/posts" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" value="{{old('slug')}}" class="border border-gray-400 p-2 w-full" name="slug"
                        id="slug" required>
                    @error('slug')
                    <p class="text-red-500 text-xs mt-2">{{$message}}</p>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    <textarea class="border border-gray-400 p-2 w-full" name="excerpt" id="excerpt" rows="3" required
                        for="excerpt">{{old('excerpt')}}</textarea>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="border border-gray-400 p-2 w-full" name="body" id="body" rows="3" required
                        for="body">{{old('body')}}</textarea>
                ...
                <div class="mb-3">
                    ...
                    <select name="category_id" id="category_id">
                        ...
                        <option value="{{$category->id}}" {{old('category_id')==$category->
                            id ? 'selected' : ''}}>{{ucwords($category->name)}}</option>
